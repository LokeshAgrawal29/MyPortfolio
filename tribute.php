...
<div class="container">
  <div class="jumbotron">
    <div class="row">
      <div class="col-xs-12">
    <h1 class="text-center">Virat Kohli</h1>
    <h2 class="text-center">The Run Machine</h2>
    <div class="thumbnail"><img src="./images/virat.jpeg" alt="virat kohli lifting his bat after hitting a century">
<div class="caption text-center">Virat Kohli lifting his bat after hitting a century.</div>
    </div>
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
<h3>Here's a time line of Virat Kohli's life:</h3>
      <ul>
      ...
      <blockquote>
            <p>"As of now Virat Kohli is the Greatest Batsman of the world"</p>
            <footer><cite>Former Indian Cricket Captain Saurav Ganguly</cite></footer>
          </blockquote>
      <h3>If you have time, you should read more about this incredible human being on his <a href="https://en.wikipedia.org/wiki/Virat_Kohli" target="_blank">Wikipedia entry</a>.</h3>
        </div>
      </div>
    </div> 
  </div>
  <footer class="text-center">
    <hr>
    <p>Written and coded by <a href="Portfolio.php" target="_blank">Lokesh Agrawal</a>.</p>
  </footer>  
</div>  
